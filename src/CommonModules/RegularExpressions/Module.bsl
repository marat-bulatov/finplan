...
Функция ТестRegExp(ТекстДляТестирования, ВыражениеRegExp, RegExp = Неопределено) Экспорт
...
Функция ReplaceRegExp(ИсходныйТекст, ВыражениеRegExp, ТекстЗамены = "",  RegExp = Неопределено) Экспорт
...
Функция ПодстрокаRegExp(Текст, ВыражениеRegExp,  RegExp = Неопределено) Экспорт
