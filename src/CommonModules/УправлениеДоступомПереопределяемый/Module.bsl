...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "Организации"; // имя вида доступа (используется в ролях для RLS)
	ВидДоступа.Представление    = НСтр("ru = 'Организации'");
	ВидДоступа.ТипЗначений      = Тип("СправочникСсылка.Организации"); // критерий ограничения доступа
	
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ТипыДоговоров"; // имя вида доступа (используется в ролях для RLS)
	ВидДоступа.Представление    = НСтр("ru = 'Типы договоров'");
	ВидДоступа.ТипЗначений      = Тип("СправочникСсылка.ТипыДоговоров"); // критерий ограничения доступа
	
	ВидДоступа = ВидыДоступа.Добавить();
	ВидДоступа.Имя = "ВидыРезидентностиКонтрагентов"; // имя вида доступа (используется в ролях для RLS)
	ВидДоступа.Представление    = НСтр("ru = 'Виды резидентности контрагентов'");
	ВидДоступа.ТипЗначений      = Тип("ПеречислениеСсылка.ВидыРезидентностиКонтрагентов"); // критерий ограничения доступа
	
	ДополнительныеОтчетыИОбработки.ПриЗаполненииВидовДоступа(ВидыДоступа);
	УправлениеСвойствамиСлужебный.ПриЗаполненииВидовДоступа(ВидыДоступа);
	РаботаСПочтовымиСообщениямиСлужебный.ПриЗаполненииВидовДоступа(ВидыДоступа);
