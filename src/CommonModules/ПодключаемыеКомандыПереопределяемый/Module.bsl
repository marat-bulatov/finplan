...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если Источники.Строки.Найти(Метаданные.Документы.ФинансовыйПлан, "Метаданные") <> Неопределено Тогда
		...
		Команда.Обработчик = "ДемоСтандартныеПодсистемыКлиент.ЗаполнитьПримечание";
